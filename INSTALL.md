...
make sim-usart sim-spi sim-twi sim-adc sim-ac sim-wdt sim-extint sim-irq
...
**Los 32 objetivos deben pasar**, y tardan unos **5 minutos** en total —`synth-check` es casi
