...
| `rtl/fpga/ecp5/axioma_ulx3s_top.v` | **Sintetiza y cierra timing** | Bitstream de 300 KiB para la ULX3S 25F. `nextpnr` mide **Fmax 18,25 MHz** tras el rutado, bajo restricción exigente; se corre a 12,5 MHz, con un margen de 1,46× |
...
bitstream   300 KiB · 35,4 % de las LUT y 60,7 % de la BRAM de la ULX3S 25F
            Fmax 18,25 MHz medida tras el rutado, y se corre a 12,5 MHz
