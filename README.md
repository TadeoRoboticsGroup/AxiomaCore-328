...
mutación   246/246 fallos inyectados, 246 detectados
cobertura   99,5 % del RTL, fusionando todas las fuentes
            20 de 25 módulos al 100 %; los 14 puntos restantes, adjudicados:
...
```bash
make mutation      # 246 fallos inyectados, ~10 min; MODIFICA el RTL mientras corre
```
