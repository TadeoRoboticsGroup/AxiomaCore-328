...
def main():
    ...
    construir("build/vcovi2", "i2cc", "tb_soc_i2c_top",
              f"sim/soc/tb_soc_i2c_top.v {RTL}{FRENTE} sim/soc/tb_soc_i2c.cpp",
    ...
    construir("build/vcovbo", "bootc", "tb_soc_uart_top",
              f"sim/soc/tb_soc_uart_top.v {RTL}{FRENTE} sim/soc/tb_soc_boot.cpp")
