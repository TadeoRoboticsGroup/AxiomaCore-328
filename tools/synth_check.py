...
PERIF = ["rtl/bus/axioma_dbus.v", "rtl/periph/axioma_gpio.v",
         ...
         "rtl/periph/axioma_clkctrl.v", "rtl/periph/axioma_irq.v"]
...
MODULOS = [
    ...
    ("axioma_spi",       ["rtl/periph/axioma_spi.v"]),
    ("axioma_twi",       ["rtl/periph/axioma_twi.v"]),
    ("axioma_adc",       ["rtl/periph/axioma_adc.v"]),
    ("axioma_ac",        ["rtl/periph/axioma_ac.v"]),
    ("axioma_wdt",       ["rtl/periph/axioma_wdt.v"]),
    ("axioma_eeprom",    ["rtl/periph/axioma_eeprom.v"]),
    ("axioma_clkctrl",   ["rtl/periph/axioma_clkctrl.v"]),
